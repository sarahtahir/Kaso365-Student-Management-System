<?php
session_start();
include "../navBar/staffAttendanceNavBar.php"
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
					...
					<a href="addStaffAttendance.php" class="btn btn-success btn-sm" ><i class="material-icons">&#xE147;</i> <span>Add Attendance</span></a>
				...
				<form action="attendance.php" method="post">
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input type="text" name="staffID" id="staffID"class="form-control" readonly >
						</div>
						<div class="form-group">
							<label>Name</label>
