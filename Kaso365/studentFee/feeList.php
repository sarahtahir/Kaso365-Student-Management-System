<?php
session_start();
include "../navBar/studFeeNavBar.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
					...
					<div class="col-xs-2">Select year and month</div>
                    <div class="col-xs-2">
				   ...
				   <select class="form-control" name="year" id="year">
					...
					<div><button type="submit" name="getFeesBtn" ><i class="fa fa-search"></i>
						</button></form>
					<a href="feeForm.php" class="btn btn-success btn-sm" ><i class="material-icons">&#xE147;</i> <span>Add Fee</span></a>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 22%;">Amount Paid  (RM)</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
