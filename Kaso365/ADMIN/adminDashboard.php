  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="../userInfo/userList/userList.php" class="w3-bar-item w3-button"><i class="fa fa-bullseye fa-fw"></i> User List</a>
        <a href="../staffInfo/staffList/staffList.php" class="w3-bar-item w3-button"><i class="fa fa-users fa-fw"></i> Staff List</a>
        <a href="../staffAttendance/staffAttendanceList.php" class="w3-bar-item w3-button"><i class="fa fa-users fa-fw"></i> Staff Attendance</a>
